...
INSERT INTO MOVIMENTACAOLOJA (FK_ID_LOJA, FK_ID_PROD, MOV_TIPO, MOV_QTDE, MOV_VALOR, MOV_PONTO_REP) 
VALUES (1, 2, 1, 10, 50.00, 100);

INSERT INTO MOVIMENTACAOLOJA (FK_ID_LOJA, FK_ID_PROD, MOV_TIPO, MOV_QTDE, MOV_VALOR, MOV_PONTO_REP) 
VALUES (2, 1, 2 , 5, 30.00, 200);
...
VALUES (1, 1, 0, 100, 5000.00, 10);

INSERT INTO ESTOQUE (ESTOQUEIDPROD,ESTOQUETRANSFERENCIA, ESTOQUETIPO, ESTOQUEQTD, ESTOQUEVALOR, ESTOQUEPONTOREP) 
VALUES (2, 1, 0, 50, 1200.00, 5);
